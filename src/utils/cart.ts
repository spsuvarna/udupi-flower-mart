...
export const calculateDeliveryCharge = (area:DeliveryArea|undefined, subtotal:number) => !area || subtotal <= 0 || subtotal >= orderPolicy.freeDeliveryThreshold ? 0 : area.deliveryCharge;
export const meetsMinimumOrder = (_area:DeliveryArea|undefined, subtotal:number) => subtotal >= orderPolicy.minimumFlowerTotal;
